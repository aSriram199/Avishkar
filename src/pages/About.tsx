        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-lg sm:text-xl text-justify leading-relaxed">
              ...
              consecutively for five years. Avishkar provides a platform to present innovative ideas while improving technical
              knowledge and communication skills. Avishkar has played a key role in encouraging research and critical thinking
          ...
          <div>
            ...
            <p className="text-lg sm:text-xl text-justify leading-relaxed mb-4">
              ...
              world challenges and suggest innovative solutions, where participants can showcase their technical expertise through
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-xl font-semibold mb-2">Round 1: Idea Presentation Round</h3>
                <p className="text-lg sm:text-xl text-justify leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Round 2: Final Round</h3>
                <p className="text-lg sm:text-xl text-justify leading-relaxed">
                  A panel of judges will evaluate the presentations and select the best participants based on the innovative ideas,
                  technical expertise and presentation skills. The leading participants will be recognized for their outstanding
                  contributions.
                </p>
              </div>
            </div>
